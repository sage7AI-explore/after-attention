...
It reads `paper/After_Attention_draft_v0.9.md` and the two figures in `figures/`, and writes
`paper/After_Attention_draft_v0.9.pdf` (21 pages). `CHANGELOG.md` records every draft revision,
